...
public class Utils {
    ...
    /**
     * Mètode per netejar el terminal, compatible amb sistemes Windows i
     * GNU/Linux
     */
    ...
    /**
     * Mètode que espera a que l'usuari premi qualsevol tecla. Al contrari que
     * els mètodes tradicionals de lectura de teclat de Java, la tecla es rep de
     * seguida, sense haver d'esperar a que l'usuari premi ENTER
    ...
    */
    ...
    /**
     * Demana un nombre enter dintre del rang indicat. Si l'usuari insereix un
     * valor incorrecte, mostra un missatge d'error i torna a demanar el nombre
     ...
     * @return la cadena amb caràcters zero afegits fins a completar la longitud
     * indicada per length
     */
